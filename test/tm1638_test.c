...
TEST(should_put_all_pin_at_output_and_high_level_when_init) {
...
TEST(should_send_trame_to_display_on) {
  TM_display_on(tm);
...
TEST(should_send_trame_to_display_off) {
  TM_display_off(tm);
...
TEST(should_send_trame_to_display_8_on_digit_1) {
...
TEST(should_send_trame_to_display_8_on_digit_2) {
...
TEST(should_send_trame_to_display_8_on_digit_3) {
...
TEST(should_send_trame_to_display_8_on_digit_4) {
...
TEST(should_send_trame_to_display_1_2_3_4_on_all_digit) {
